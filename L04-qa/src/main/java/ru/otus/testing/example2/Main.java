package ru.otus.testing.example2;

import ru.otus.testing.example2.services.*;

public class Main {

    public static void main(String[] args) {
        IOService closedConsoleIOService = new ClosedConsoleIOService();
        IOService openedConsoleIOService = new OpenedConsoleIOService(System.out, System.in);
